 ...
 * Existing source: worker-artifact-handoff.js; draft-repair-operations.js (coverage repair).
...
export class DraftCoverageRepairStep extends Step {
  ...
  async _execute() {
    throw new Error("DraftCoverageRepairStep._execute() is not implemented");
  }
}
