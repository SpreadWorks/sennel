...
const ENTRIES = Object.freeze([
  ...
  workerHandoffOwned("draft-refine", "draft-gate-repair", "draft schema and revision transaction"),
  workerHandoffOwned("draft-gate-repair", "draft-coverage-review", "Gate-authorized draft repair and revision transaction"),
  ...
  workerHandoffOwned("test-repair", "test-gate", "Requirement-bound repaired candidate bundle validator"),
  commandOwned("test-gate", "test-gate, test-repair, next Requirement test-generate, or implement"),
  ...
  commandOwned("task-triage", "task-repair or task-gate"),
  workerSourceOwned("task-repair", "optional", "task-review or task-gate"),
