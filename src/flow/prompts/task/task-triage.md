...
- Do not edit any source, canonical artifact, or Flow state. Return only structured output: empty `issues`, null `overview`, `repair`, and `noChangeReason`, and the complete `triage.dispositions`.
