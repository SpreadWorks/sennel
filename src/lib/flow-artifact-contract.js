...
const FLOW_ARTIFACT_PLACEMENTS = new Map([
  ...
  ...[
    ...
    "task.review", "task.review.unsealed.checkpoint", "task.review.recovery.authorization", "task.gate.source", "task.gate", "task.mutation.lineage", "review.evidence", "activity.evidence",
...
function stepOwnerFor(logicalKey) {
  ...
  if (logicalKey === "task.review" || logicalKey === "task.review.unsealed.checkpoint" || logicalKey === "task.review.recovery.authorization") return FlowArtifactStepOwner.taskCollection("review");
