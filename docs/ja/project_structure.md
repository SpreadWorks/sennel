...
| ディレクトリ | ファイル数 | 役割 |
| --- | --- | --- |
| src/flow | 247 | controller, lib, cli, config, model, middleware, get guardrail flow command, Typed review-observation model with validation and legacy normalization., Retry counter and failure classification utility, route, test, Metric setter command handler |
