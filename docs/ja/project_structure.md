...
| ディレクトリ | ファイル数 | 役割 |
| --- | --- | --- |
| src/flow | 253 | controller, lib, cli, config, model, route, get guardrail flow command, middleware, Typed review-observation model with validation and legacy normalization., Retry counter and failure classification utility, test, Metric setter command handler |
