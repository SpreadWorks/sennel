...
| ディレクトリ | ファイル数 | 役割 |
| --- | --- | --- |
| src/flow | 302 | controller, lib, cli, model, other, middleware, config, route, get guardrail flow command, Typed review-observation model with validation and legacy normalization., Retry counter and failure classification utility, test, Metric setter command handler |
